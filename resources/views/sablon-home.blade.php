...
<body class="bg-[#0f0f0f] text-neutral-100 antialiased" 
    ...
    <header class="relative min-h-screen flex flex-col items-center justify-center px-8 text-center hero-bg">
        <div class="z-10 flex flex-col items-center">
            <div class="relative mb-12 group">
                <div class="absolute -inset-1 bg-amber-500 rounded-2xl blur opacity-25 group-hover:opacity-50 transition duration-1000"></div>
                <img src="{{ asset('img/logo.jpg') }}" alt="Journa Sablon Logo" class="relative w-64 md:w-96 rounded-2xl shadow-2xl border border-white/10">
            </div>
            <h1 class="text-5xl md:text-8xl font-bold tracking-tighter uppercase mb-4">Journa Sablon</h1>
            <div class="h-1.5 w-32 bg-amber-500 mb-8"></div>
            <p class="max-w-3xl mx-auto text-neutral-200 text-xl md:text-2xl leading-relaxed italic drop-shadow-lg">
                "Pusat layanan sablon premium dengan kualitas artistik tinggi. <br class="hidden md:block"> Kami mewujudkan ide Anda menjadi karya di atas kain."
            </p>
            <a href="#sablon" class="mt-12 px-10 py-4 bg-white text-black font-bold uppercase text-sm tracking-[0.3em] rounded-full hover:bg-amber-500 transition-all hover:scale-105">Lihat Katalog</a>
        </div>
    </header>
   ...
   <section id="about" class="max-w-7xl mx-auto px-8 py-32 grid grid-cols-1 md:grid-cols-2 gap-20 items-center border-b border-white/5">
        <div class="relative group" style="perspective: 1500px;"> 
            ...
            <div class="relative overflow-hidden rounded-[3rem] aspect-square bg-[#705515] border border-white/10 shadow-2xl transition-all duration-700 ease-out transform-gpu group-hover:rotate-y-12 group-hover:-rotate-x-6 group-hover:scale-105" 
                ...
                <img src="{{ asset('img/logo2.png') }}" class="w-full h-full object-cover transition duration-1000 group-hover:scale-110" style="transform: translateZ(30px);" alt="Journa Studio Logo">
                <div class="absolute bottom-10 left-10 text-left transition-transform duration-700 group-hover:translate-z-50" style="transform: translateZ(50px);">
        ...
        <div>
            <h2 class="text-5xl font-bold mt-6 mb-8 tracking-tighter uppercase leading-tight text-white">Sejarah Journa Sablon</h2>
            <div class="space-y-6">
                <p class="text-neutral-400 leading-relaxed text-lg">
                    <strong class="text-white">Journa Studio Printing</strong> resmi didirikan pada tahun <strong class="text-amber-500">2022</strong>. Berawal dari dedikasi mendalam untuk menciptakan standar baru dalam produksi kaos, kami hadir sebagai spesialis sablon kaos premium yang menggabungkan kenyamanan bahan dengan detail visual yang tajam.
                </p>
                <p class="text-neutral-500 leading-relaxed italic border-l-2 border-amber-500 pl-6">
                    "Bagi kami, sepotong kaos bukan sekadar pakaian, melainkan sebuah karya seni yang harus nyaman dipakai dan membanggakan untuk dipandang."
                </p>
            </div>
        </div>
    </section>
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
                <div class="group cursor-pointer text-center" @click="selectProduct('Cotton Combed 24s White')">
                    <div class="aspect-[3/4] rounded-2xl overflow-hidden bg-neutral-900 border border-white/5 mb-4 relative">
                        <img src="{{ asset('img/kaos-putih.webp') }}" class="w-full h-full object-cover group-hover:scale-110 transition duration-500" alt="Cotton Combed 24s">
                ...
                <div class="group cursor-pointer text-center" @click="selectProduct('Cotton Combed 30s White')">
                    <div class="aspect-[3/4] rounded-2xl overflow-hidden bg-neutral-900 border border-white/5 mb-4 relative">
                        <img src="{{ asset('img/kaos-hitam.jpg') }}" class="w-full h-full object-cover group-hover:scale-110 transition duration-500" alt="Cotton Combed 30s">
                        <div class="absolute inset-0 bg-amber-500/10 opacity-0 group-hover:opacity-100 transition-opacity"></div>
                    </div>
                ...
                <div class="group cursor-pointer text-center" @click="selectProduct('Cotton Combed 24s Premium')">
                    <div class="aspect-[3/4] rounded-2xl overflow-hidden bg-neutral-900 border border-white/5 mb-4 relative">
                        <img src="{{ asset('img/kaos-biru-muda.jpeg') }}" class="w-full h-full object-cover group-hover:scale-110 transition duration-500" alt="Cotton Combed 24s">
                        <div class="absolute inset-0 bg-amber-500/10 opacity-0 group-hover:opacity-100 transition-opacity"></div>
                    </div>
                    <h3 class="text-white font-bold text-xs uppercase tracking-widest">Cotton Combed 24s</h3>
                ...
                <div class="group cursor-pointer text-center" @click="selectProduct('Cotton Combed 30s Premium')">
                    <div class="aspect-[3/4] rounded-2xl overflow-hidden bg-neutral-900 border border-white/5 mb-4 relative">
                        <img src="{{ asset('img/kaos-biru.jpg') }}" class="w-full h-full object-cover group-hover:scale-110 transition duration-500" alt="Cotton Combed 30s">
                        <div class="absolute inset-0 bg-amber-500/10 opacity-0 group-hover:opacity-100 transition-opacity"></div>
                    </div>
                    <h3 class="text-white font-bold text-xs uppercase tracking-widest">Cotton Combed 30s</h3>
                ...
                <div class="group cursor-pointer text-center" @click="selectProduct('Cotton Combed Exclusive')">
                    <div class="aspect-[3/4] rounded-2xl overflow-hidden bg-neutral-900 border border-white/5 mb-4 relative">
                        <img src="{{ asset('img/kaos-kuning.jpg') }}" class="w-full h-full object-cover group-hover:scale-110 transition duration-500" alt="Cotton Combed 24/30s">
                        <div class="absolute inset-0 bg-amber-500/10 opacity-0 group-hover:opacity-100 transition-opacity"></div>
                    </div>
   ...
   <section id="testimoni" class="max-w-7xl mx-auto px-8 py-32">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div class="glass p-8 rounded-[2.5rem] border border-white/5 flex flex-col justify-between hover:border-amber-500/30 transition-all duration-500 group">
                <div class="mb-8">
   ...
   <section id="kontak" class="max-w-7xl mx-auto px-8 py-32 border-t border-white/5">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-10">
            <div class="lg:col-span-7 w-full h-[500px] md:h-[600px] rounded-[3rem] overflow-hidden border border-white/10 grayscale hover:grayscale-0 transition duration-1000 shadow-[0_20px_50px_rgba(0,0,0,0.5)] relative group">
                <div class="absolute inset-0 bg-amber-500/5 pointer-events-none group-hover:opacity-0 transition"></div>
           <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3960.745619104825!2d109.15119767898834!3d-6.920983775232521!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e6fb9b649cf805b%3A0xbe91d40929be9e02!2sJOURNA%20STUDIO%20SABLON%20DAN%20KONFEKSI!5e1!3m2!1sid!2sid!4v1767020682323!5m2!1sid!2sid"
                        width="100%" height="100%" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
            </div>

            <div class="lg:col-span-5 glass p-10 md:p-14 rounded-[3rem] border border-white/10 flex flex-col justify-center shadow-2xl">
                <div class="mb-12">
                    <h4 class="text-amber-500 font-bold uppercase text-xs tracking-widest mb-4 italic">Alamat Studio</h4>
                    <p class="text-2xl text-white font-medium leading-snug">Gang singadipura Jl. Projosumarto II, Seturancang, Setu, Kec. Tarub, Kabupaten Tegal, Jawa Tengah</p>
                </div>
                
                <div class="space-y-10">
                    <div>
                        <h4 class="text-amber-500 font-bold uppercase text-xs tracking-widest mb-3 italic">WhatsApp</h4>
                        <a href="https://wa.me/6289686202603" target="_blank" class="text-2xl md:text-3xl font-bold text-white hover:text-[#25D366] transition-all flex items-center gap-4 group">
                    ...
                    <div>
                        <h4 class="text-amber-500 font-bold uppercase text-xs tracking-widest mb-3 italic">Instagram</h4>
                        <a href="https://instagram.com/journastudio" target="_blank" class="text-2xl md:text-3xl font-bold text-white hover:text-[#E4405F] transition-all flex items-center gap-4 group">
                    ...
                    <div>
                        ...
                        <a href="https://facebook.com/journastudio" target="_blank" class="text-2xl md:text-3xl font-bold text-white hover:text-[#1877F2] transition-all flex items-center gap-4 group">
    ...
    <footer class="p-20 text-center border-t border-white/5 bg-[#0a0a0a]">
        <div class="flex flex-col items-center mb-6">
             ...
             <div class="text-xl font-bold tracking-[0.3em] text-white uppercase">Journa Sablon</div>
        </div>
        <p class="opacity-30 text-[10px] tracking-[0.8em] uppercase mb-8 italic text-neutral-400">Premium Printing Laboratory Since 2022.</p>
        <p class="opacity-20 text-[9px] uppercase tracking-widest text-neutral-500">©2025 Journa Sablon Printing Lab. Made with Passion in Tegal.</p>
    </footer>
